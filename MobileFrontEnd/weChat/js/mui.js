...
(function($, window) {
	function detect(ua) {
		...
		var funcs = [
			...
			function() { //Mobilewechat
				var wechat = ua.match(/(MicroMessenger)\/([\d\.]+)/i);
				if (wechat) { //Mobilewechat
					this.os.wechat = {
...
(function($) {
	...
	$(function() {
		...
		if ($.os.wechat) {
			...
			classList.add('mui-Mobilewechat');
		}
		if (os.length) {
...
(function($, window, document) {
	...
	var CLASS_GRID_VIEW = 'mui-grid-public';
	var CLASS_RADIO_VIEW = 'mui-table-public-radio';
	var CLASS_TABLE_VIEW_CELL = 'mui-table-public-cell';
